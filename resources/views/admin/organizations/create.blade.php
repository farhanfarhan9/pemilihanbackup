...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-sm-12 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Create an organization</h5><hr>
                    @if (session('error'))
                    ...
                    <form action="{{ route('admin.organizations.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('shortname') is-invalid @enderror" type="text" name="shortname" id="shortname" value="{{ old('shortname') }}">
                            @error('shortname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
